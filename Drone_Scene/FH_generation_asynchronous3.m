...
%   finally_message - 瀑布图索引标注信息。
%   sig_message - 原始信号参数信息矩阵。


function [FH_data, used_Fc_sequence, finally_message, sig_message, part_long,rf] = FH_generation_asynchronous3(Fs, Fd, SNR, ...
    sig_power, nfft, data_long, number)
