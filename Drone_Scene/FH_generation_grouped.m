...
function [FH_data, Fc_rand, finally_message, sig_message, part_long] = FH_generation_grouped(Fs, Fd, SNR, noise_power, nfft, data_long, number)
...
Fc = Fc_total(number : 4 :end);
sig = zeros(1,data_long);
part_sig_len = 4000000; % 20000 信号长度0.0004s   4000000 0.08s
part_interval = 1000000; % 5000 信号间时域的保护间隔0.0001s  1000000 0.02s
